...
import mnist_tensorflow_v1_input_data

from tensorflow.examples.tutorials.mnist import input_data
import tensorflow.compat.v1 as tf
tf.disable_v2_behavior()

trainDataPath = "./MNIST_data"
mnist = input_data.read_data_sets(trainDataPath, one_hot=True)
...
def main(_):
  ...
  mnist = mnist_tensorflow_v1_input_data.read_data_sets(FLAGS.work_dir, one_hot=True)
